    ...
    <section class="relative">
      ...
      <div class="container mx-auto overflow-hidden">
          ...
          <div class="w-auto">
            ...
            <div class="flex flex-wrap items-center">
              ...
              <div class="w-auto lg:hidden">
                <a href="#">
                  <svg class="navbar-burger text-indigo-600" width="51" height="51" viewbox="0 0 56 56" fill="none"
        ...
        <div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-4/6 sm:max-w-xs z-50">
          ...
          <nav class="relative z-10 px-9 pt-8 bg-white h-1/2 overflow-y-auto">
        ...
        <div class="w-full md:w-1/4 px-4 mb-4 md:mb-0">
          ...
          <div class="flex">
            <ul>
              ...
              <li>
                <a href="/tasks/{{$task->id}}" class="mt-3 pt-2  w-full flex ">
                  <span class="pr-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      <path stroke-linecap="round" stroke-linejoin="round"
                        d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 019 9v.375M10.125 2.25A3.375 3.375 0 0113.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M9 15l2.25 2.25L15 12">
